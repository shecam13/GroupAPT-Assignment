...
public class NVPAPICaller
{
    ...
    public string APIUsername = "<c.v.galea-facilitator_api1.gmail.com>";
    private string APIPassword = "<LVVX2ZZPK8BNVD98>";
    private string APISignature = "<AFcWxV21C7fd0v3bYYYRCpSSRI31AuXZyLaZ6MAnN8mxGvO9tdRXMVd>";
