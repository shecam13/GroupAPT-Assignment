...
namespace APTEventAssignment.Controllers
{
    ...
    public class VenueZonesController : Controller
    {
        ...
        private void UpdateZone (VenueZone venueZone, AddVenueZoneViewModel addviewmodel)
        {
           ...
           // venueZone.Venue.Venue_Name = addviewmodel.VenueZone_VenueName;
        ...
        //public ActionResult Create([Bind(Include = "VenueZone_ID,VenueZone_Name,VenueZone_VenueID,VenueZone_Code,VenueZone_Rows,VenueZone_Columns,VenueZone_Deleted")] VenueZone venueZone)
